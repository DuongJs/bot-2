...
${Date.now() - ping}ms.\n\n`}`
    ...
    var callback = () =>
      api.sendMessage({
        body: `ㅤㅤ🌸 𝐀𝐃𝐌𝐈𝐍 𝐁𝐎𝐓 🌸\n
👀 𝐓𝐞̂𝐧: 𝗡𝗴𝘂𝘆𝗲̂̃𝗻 𝗗𝘂𝘆 𝗠𝗮̣𝗻𝗵 𝗛𝘂̀𝗻𝗴
❎ 𝐓𝐮𝐨̂̉𝐢: 𝟭𝟳
👤 𝐆𝐢𝐨̛́𝐢 𝐓𝐢́𝐧𝐡: 𝗡𝗮𝗺
💫 𝐂𝐡𝐢𝐞̂̀𝐮 𝐜𝐚𝐨 𝐜𝐚̂𝐧 𝐧𝐚̣̆𝐧𝐠: 𝗺𝟯𝟬 𝘅 𝟱𝟱𝗸𝗴
💘 𝐌𝐨̂́𝐢 𝐪𝐮𝐚𝐧 𝐡𝐞̣̂: 𝗛𝗲̣𝗻 𝗵𝗼̀
🌎 𝐐𝐮𝐞̂ 𝐪𝐮𝐚́𝐧: 𝗛𝗮̉𝗶 𝗽𝗵𝗼̀𝗻𝗴
👫 𝐆𝐮: 𝗕𝗶𝗲̂́𝘁 𝗹𝗮̀𝗺 𝘃𝗶𝗲̣̂𝗰 𝗻𝗵𝗮̀, 𝗻𝗴𝗼𝗮𝗻 𝗻𝗴𝗼𝗮̃𝗻 𝗵𝗶𝗲̂̀𝗻 𝗹𝗮̀𝗻𝗵
🌸 𝐓𝐢́𝐧𝐡 𝐜𝐚́𝐜𝐡: 𝗛𝗶𝗲̂̀𝗻 𝗹𝗮̀𝗻𝗵
🌀 𝐒𝐨̛̉ 𝐭𝐡𝐢́𝐜𝐡: 𝗖𝗵𝗼̛𝗶 𝗴𝗮𝗺𝗲, 𝗻𝗵𝗮̆́𝗻 𝘁𝗶𝗻, 𝗰𝗮𝗹𝗹
💻𝐂𝐨𝐧𝐭𝐚𝐜𝐭💻
☎ 𝗦𝗗𝗧 & 𝗭𝗮𝗹𝗼: 𝟬𝟯𝟵𝟲.𝟱𝟳𝟳.𝟯𝟮𝟲
🌐 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤: https://www.facebook.com/mhung.cutii.s1 🌺`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100000664756191}/picture?height=720&width=720&access_token=1073911769817594|aa417da57f9e260d1ac1ec4530b417de`)).pipe(
...
return api.sendMessage("𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐫𝐞𝐥𝐨𝐚𝐝𝐞𝐝 𝐜𝐨𝐧𝐟𝐢𝐠.𝐣𝐬𝐨𝐧", event.threadID, event.messageID);    
          ...
          /// admin only ///
        case "5": {
          if (event.senderID != 100000664756191) return api.sendMessage(`» 𝐌𝐚̀𝐲 𝐓𝐮𝐨̂̉𝐢 𝐂𝐚̣̆𝐜 𝐆𝐢̀ 𝐌𝐚̀ 𝐗𝐚̀𝐢 😏`, event.threadID, event.messageID)
